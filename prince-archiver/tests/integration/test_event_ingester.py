...
from prince_archiver.adapters.file import AsyncFileSystem, SystemDir, EventFile
...
def fixture_event_file_factory(src_dir: Path) -> Callable[[datetime], Path]:
    ...
    def _event_file_factory(dt: datetime):
